...
namespace SiteHandTraining.Droid.Services
{
    ...
    public class MyFirebaseMessagingService : FirebaseMessagingService {
        ...
        private void SendNotification(string messageBody, IDictionary<string, string> data)
        {
            ...
            var notificationBuilder = new NotificationCompat.Builder(this, MainActivity.CHANNEL_ID).SetSmallIcon(Resource.Drawable.ic_audiotrack_dark).SetContentTitle("FCM Message").SetContentText(messageBody).SetAutoCancel(true).SetContentIntent(pendingIntent);
